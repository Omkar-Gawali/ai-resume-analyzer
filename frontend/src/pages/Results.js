...
const ScoreRing = ({ score, grade }) => {
  ...
  }, [score, c]); // eslint-disable-line react-hooks/exhaustive-deps
    ...
    <div style={{ position: "relative", width: 156, height: 156 }}>
      ...
      >
        ...
        <circle
          ...
          style={{
            transition: "stroke-dasharray 1.6s cubic-bezier(0.34,1.56,0.64,1)",
        ...
        <div style={{ padding: "0 18px 18px" }}>
          ...
          <div style={{ marginBottom: 14 }}>
            ...
            >
              <span>
                Required match:{" "}
                <b style={{ color }}>{job.required_match_percent}%</b>
              </span>
              <span>
                Overall (with bonus):{" "}
                <b style={{ color }}>{job.match_percent}%</b>
              </span>
            </div>
          </div>
...
export default function Results() {
  ...
  const radarData =
    detailed[0]?.matched_required?.slice(0, 7).map((s) => ({
  ...
  /* Section presence */
  const sectionList = Object.entries(sections).filter(
    ([k]) => k !== "languages_spoken",
  );
      ...
      >
        ...
        <div style={{ marginBottom: 40 }}>
          ...
          <p style={{ color: T.muted, fontSize: "0.95rem", margin: 0 }}>
            AI-powered breakdown — score, skills, job fit, ATS health, and what
            to fix next
          </p>
        </div>
        ...
        >
          ...
          >
            <SectionTitle icon={<Award size={14} />} color={T.amber}>
              Resume Score
            </SectionTitle>
          ...
          {/* Score Breakdown */}
          <Card>
            <SectionTitle icon={<TrendingUp size={14} />} color={T.sky}>
              Score Breakdown
            </SectionTitle>
            {Object.entries(breakdown).map(([key, val]) => (
              <BreakdownBar
                ...
                color={
                  val / (breakdownMaxes[key] || 10) >= 0.7
                    ? T.teal
                    : val / (breakdownMaxes[key] || 10) >= 0.4
                      ? T.amber
                      : T.rose
                }
              />
          ...
          {/* Candidate Profile */}
          <Card>
            <SectionTitle icon={<User size={14} />} color={T.purple}>
              Candidate Profile
            </SectionTitle>
            ...
            <div style={{ marginBottom: 18 }}>
              ...
              {[
                ...
                },
                {
                  ...
                  val: contactInfo.linkedin,
                  color: "#0a8",
                },
                {
                  icon: <Github size={12} />,
                  val: contactInfo.github,
                  color: T.text,
                },
                {
                  icon: <Globe size={12} />,
                  val: contactInfo.portfolio,
                  color: T.amber,
                },
              ].map((c, i) => (
                <div
                ...
                >
                  <span
                    style={{ color: c.val ? c.color : T.dim, flexShrink: 0 }}
                  >
                    {c.icon}
                  </span>
                  <span
        ...
        >
          ...
          <Card glow={atsCheck.ats_friendly ? T.teal : T.rose}>
            ...
            <div
              style={{
                ...
                padding: "14px 18px",
                borderRadius: 14,
                background: atsCheck.ats_friendly
                  ? `${T.teal}0c`
                  : `${T.rose}0c`,
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontSize: "0.78rem", color: T.muted }}>
                  {atsCheck.ats_friendly
                    ? "Your resume should parse well"
                    : `${atsCheck.warnings?.length} issue(s) found`}
                </div>
              </div>
            </div>
          ...
          <Card>
            <SectionTitle
              icon={<Layers size={14} />}
              color={T.sky}
              badge={`${presentCount}/${sectionList.length}`}
            >
              Resume Sections
            </SectionTitle>
            <div
        ...
        <div style={{ marginBottom: 16 }}>
          <Card>
            ...
            {Object.keys(catSkills).length > 0 ? (
              ...
              <p style={{ color: T.muted, fontSize: "0.88rem" }}>
                No skills detected
              </p>
            )}
          </Card>
              ...
              >
                ...
                <div>
                  ...
                  <div style={{ color: T.muted, fontSize: "0.8rem" }}>
                    You cover the essentials for your top match
                  </div>
                </div>
              </div>
            )}
        ...
        <div style={{ marginBottom: 16 }}>
          <Card>
            ...
            {detailed.length > 0 ? (
              ...
              <p style={{ color: T.muted, fontSize: "0.88rem" }}>
                No job matches found. Add more skills to improve matching.
              </p>
            )}
          </Card>
        </div>
            ...
            {suggestions.length > 0 ? (
              ...
              >
                {suggestions.map((s, i) => {
                  const sug =
                    typeof s === "string"
                      ? { message: s, priority: "medium", category: "General" }
                      : s;
        ...
        <div
          style={{
            ...
            overflow: "hidden",
            background:
              "linear-gradient(135deg, rgba(124,109,255,0.1) 0%, rgba(56,197,245,0.05) 100%)",
            border: `1px solid ${T.border}`,
          }}
        >
          <div
            style={{
              ...
              inset: 0,
              background:
                "radial-gradient(circle at 50% 50%, rgba(124,109,255,0.08) 0%, transparent 70%)",
              pointerEvents: "none",
            }}
          />
          <div style={{ position: "relative" }}>
            ...
            >
              Apply the suggestions above, upload your improved resume, and
            ...
            <Link
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = `0 8px 32px ${T.purple}55`;
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = "none";
                e.currentTarget.style.boxShadow = `0 4px 24px ${T.purple}40`;
              }}
            >
